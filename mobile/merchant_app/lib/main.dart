...
void main() async {
  runZonedGuarded(() async {
    ...
    CrashReportingService().setCustomKey('app_type', 'merchant_app');
    ...
    await AnalyticsService().logEvent(AnalyticsEvents.appOpen, parameters: {
      'app': 'daleel_merchant_app',
      'launch_time': DateTime.now().toIso8601String(),
    });

    AppLogger.info('Daleel Merchant Portal initialized successfully', tag: 'BOOT');
